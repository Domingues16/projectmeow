...
message.channel.stopTyping(true);
		if (!cmd[0]) {
			return message.channel.send('Diga o nome do anime.');
		}

		if (!cmd[1]) {
			return message.channel.send('Diga o número do episódio.');
		}

		let msg = await message.channel.send('Carregando informações...');
